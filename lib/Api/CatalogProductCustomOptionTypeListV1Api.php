...
class CatalogProductCustomOptionTypeListV1Api
{
    ...
    public function catalogProductCustomOptionTypeListV1GetItemsGetWithHttpInfo()
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\CatalogDataProductCustomOptionTypeInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\CatalogDataProductCustomOptionTypeInterface[]', $e->getResponseHeaders());
